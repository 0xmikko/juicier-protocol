...
export interface VitaminTokenContract
  extends Truffle.Contract<VitaminTokenInstance> {
  "new"(
    _underlyingAssetDecimals: number | BN | string,
    _name: string,
    _symbol: string,
    meta?: Truffle.TransactionDetails
  ): Promise<VitaminTokenInstance>;
}
...
export interface VitaminTokenInstance extends Truffle.ContractInstance {
  /**
