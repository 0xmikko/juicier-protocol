...
export interface AaveLandingPoolMockContract
  extends Truffle.Contract<AaveLandingPoolMockInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<AaveLandingPoolMockInstance>;
}
...
export interface AaveLandingPoolMockInstance extends Truffle.ContractInstance {
  addReserve: {
    (
